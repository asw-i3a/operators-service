...
public class AuthController {
	...
	String operatorId = service.auth(payload.get("email").toString(), payload.get("password").toString());
	...
	return new ResponseEntity<String>(new JSONObject(result).toString(), HttpStatus.UNAUTHORIZED);
    }
}
